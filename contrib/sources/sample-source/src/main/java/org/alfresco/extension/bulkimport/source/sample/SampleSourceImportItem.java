...
/**
 * This class represents the <code>BulkImportSource</code> portion of the sample custom bulk import
 * source.
 *
 * @author Peter Monks (pmonks@gmail.com)
 *
 */
public final class SampleSourceImportItem extends AbstractBulkImportItem<SampleSourceImportItemVersion> {
