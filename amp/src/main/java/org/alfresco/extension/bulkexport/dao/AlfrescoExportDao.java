...
public interface AlfrescoExportDao 
{
    ...
    /**
     * Method to check a specific exists property
     * 
     * @param nodeRef Alfresco Node Reference
     * @param propertyQName {@link QName} object
     * @return {@link String}
     ...
     * Method to get a {@link NodeRef} from {@link String}
     * 
     * @param nodeRef Alfresco Parent Node Reference in {@link String} format
     * @return {@link NodeRef}
     * @throws Exception
     */
    public NodeRef getParentNodeRef(NodeRef nodeRef) throws Exception;
