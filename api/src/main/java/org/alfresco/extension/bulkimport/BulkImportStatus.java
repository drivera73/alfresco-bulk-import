...
public interface BulkImportStatus
{
    ...
    /**
     * @param counterName The name of the source counter start to retrieve <i>(must not be null, empty or blank)</i>.
     * @return The time, in nanos, at which the given counter was first incremented <i>(will be null if an import isn't in process, or if the counterName doesn't exist)</i>.
     */
    Long getSourceCounterStart(String counterName);
    ...
    /**
     * @param counterName The name of the source counter end to retrieve <i>(must not be null, empty or blank)</i>.
     * @return The time, in nanos, at which the given counter was frozen <i>(will be null if an import isn't in process, or if the counterName doesn't exist)</i>.
     */
    Long getSourceCounterEnd(String counterName);
     ...
     * @return The time, in nanos, at which the given counter was first incremented <i>(will be null if an import isn't in process, or if the counterName doesn't exist)</i>.
     */
    Long getTargetCounterStart(String counterName);
     ...
     * @return The time, in nanos, at which the given counter was frozen <i>(will be null if an import isn't in process, or if the counterName doesn't exist)</i>.
     */
    Long getTargetCounterEnd(String counterName);
    ...
    /**
     * Reset all the counters included in this object
     */
    void resetCounters();
}
